...
public class HomeDataBean {
    ...
    public static class TypeBrand {
        ...
        public String getFirstLable2() {
            return firstLable2;
        }

        public void setFirstLable2(String secondLable) {
            this.firstLable2 = secondLable;
        }
        ...
        public String getSecondLable2() {
            return secondLable2;
        }

        public void setSecondLable2(String secondLable2) {
            this.secondLable2 = secondLable2;
        }
        ...
        public String getThirdLable2() {
            return thirdLable2;
        }

        public void setThirdLable2(String thirdLable2) {
            this.thirdLable2 = thirdLable2;
        }
    }
