...
//                View view1 = LayoutInflater.from(parent.getContext()).inflate(R.layout.test_item_banner, parent, false);
//                viewHolder = new BannerHolder(view1);
    ...
    private void setTypeItemBanner(BannerHolder holder, HomeDataBean.TypeBanner banner) {
        ...
        holder.banner.setOnBannerListener(new OnBannerListener() {
            ...
            public void OnBannerClick(int position) {
                Log.v("hello", "banner item " + position + " clicked.");
            }
        });
    ...
    class BrandHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.brand_first_lable2)
        TextView brandFirstLable2;
        ...
        @BindView(R.id.brand_second_lable2)
        TextView brandSecondLable2;
        ...
        @BindView(R.id.brand_third_lable2)
        TextView brandThirdLable2;
